            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="/"> <img src="/download.png" alt="logo" style="height: 70px"> </a>
                ...
                <div class="col-lg-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h5>Health Records officers registration Board of Nigeria</h5>
                            <h1>Accounting software</h1>
                            <p>Enterprise Resources for Accounting (ERA) is a collection of related
                                modules ranging from budgeting, vendor invoice management, öxed
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="{{ asset('front/js/jquery.nice-select.min.j') }}s"></script>
    <!-- custom js -->
