                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-stripe">
                                ...
                                <tbody>
                                 <?php
                                  ...
                                  <tr>
                                    ...
                                    <tr>
                                        {{-- <td>{{ $key + 1}}</td> --}}
                                        <td>{{ strtoupper($item->assest_category) }} </td>
                                        <td>{{ $item->note }} </td>
                                    ...
                                    <tr>
                                        <td><strong>TOTAL {{ strtoupper($assest_type) }}</strong></td>
                                        <td></td>
                                  ...
                                  @endforeach
                                  <tr>
                                    <td style="text-align: right"> <strong>TOTAL LIABILITIES F = D + E </strong></td>
                                    <td></td>
                                    <td>{{ number_format($sumTotalLiability, 2) }}</td>
                                  </tr>
                                  <tr>
                                    <td style="text-align: right"> <strong>NET ASSETS G  = C - F </strong></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td style="text-align: right"><strong> TOTAL EQUITY AND LIABILITY </strong></td>
                                    <td></td>
