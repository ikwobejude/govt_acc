                      ...
                      <tbody>
                        <tr>
                          <td style="padding: 30px"> 
                            ...
                            <p><strong>Your password has been successfully reset on  {{ \Carbon\Carbon::now()->format('l jS \\of F Y h:i:s A') }} </strong></p>
                            <p>If you did not Initiate this changes,  call our 24/7 contact center immediately on 08136759553, 09132112512.</p>
