...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card mb-4">
          <h5 class="card-header">New Asset Size</h5>
          <div class="card-body">
            <form action="{{ route('asset.size.post') }}" method="post">
                @csrf
                <div class="fieldset">
                    <h1>Asset Size</h1>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control  @error('assest_size') is-invalid @enderror" name="assest_size" id="floatingInput" placeholder="Asset Size" value="{{ old('assest_size')}}" />
